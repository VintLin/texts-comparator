...
def get_project_info() -> Dict[str, str]:
    ...
    project_info_path = root_path / "textscomparator" / "__version__.py"
...
setup(
    ...
    project_urls={
        "Source": "https://github.com/VintLin/texts-comparator",
        "Changelog": "https://github.com/VintLin/texts-comparator/releases",
        # "Documentation": "https://github.com/VintLin/texts-comparator/documentation",
    },
    options=options,
    executables=[
            Executable(os.path.join("textscomparator", "__main__.py"), target_name="textscomparator.exe"),
        ],
)